...
function App() {
  ...
  // Dynamic styles based on drawer state
  ...
  // Dynamic styles for content with footer
  const getMainContentWithFooterStyle = (additionalStyles: React.CSSProperties = {}) => ({
    padding: 0,
    margin: 0,
    marginTop: 0,
    marginLeft: isDrawerOpen ? '320px' : '0',
        ...
        <Routes>
          ...
          <Route path="/" element={
            <>
              ...
              <main style={getMainContentStyle({ height: 'calc(100vh - 120px)' })}>
          ...
          <Route path="/control" element={
            <>
              <Navigation currentUser={currentUser} onLogout={handleLogout} onDrawerStateChange={handleDrawerStateChange} />
              <main style={getMainContentStyle({ height: 'calc(100vh - 120px)', overflow: 'hidden' })}>
          ...
          <Route path="/battery" element={
            <>
              <Navigation currentUser={currentUser} onLogout={handleLogout} onDrawerStateChange={handleDrawerStateChange} />
              <main style={getMainContentStyle({ height: 'calc(100vh - 120px)', overflowY: 'auto' })}>
                <BatteryDashboard />
              </main>
              <SystemFooter isDrawerOpen={isDrawerOpen} />
            </>
          ...
          <Route path="/profile" element={
            <>
              <Navigation currentUser={currentUser} onLogout={handleLogout} onDrawerStateChange={handleDrawerStateChange} />
              <main style={getMainContentStyle({ minHeight: 'calc(100vh - 120px)', overflowY: 'auto' })}>
                <Profile />
              </main>
              <SystemFooter isDrawerOpen={isDrawerOpen} />
            </>
